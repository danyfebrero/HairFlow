...
using HairFlow.Extensions;

namespace HairFlow.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class CategoryItemController : Controller
    {
        ...
        public async Task<IActionResult> Index(int categoryId)
        {
            List<CategoryItem> list = await (from catItem in _context.CategoryItem
                                             ...
                                             select new CategoryItem
                                             {
                                                 ...
                                                 MadiaTypeId = catItem.MadiaTypeId,
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,CategoryId,MadiaTypeId,DateTimeItemReleased")] CategoryItem categoryItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,CategoryId,MadiaTypeId,DateTimeItemReleased")] CategoryItem categoryItem)
        {
