...
namespace HairFlow.Areas.Admin.Controllers
{
    ...
    public class MediaTypeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,TThumbnailImagePath")] MediaType mediaType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,TThumbnailImagePath")] MediaType mediaType)
        {
            if (id != mediaType.Id)
            {
                return NotFound();
